...
<body>
    <div id="Dinamica">
        ...
        <section id="Tabela">
            ...
            <table id="Tabela_Vendas" class="table table-striped table-hover"
                style="width:100%; border:1px solid #f5f5f5;">

                <thead>
                    <tr>
                        <th class="text-center" style="width: 50%;">Comprador</th>
                        <th class="text-center" style="width: 50%;">Valor da Venda</th>
                    </tr>
                </thead>

                <tbody>
                    <?php foreach ($rowVendas as $data) { ?>

                    <tr>
                        <td class="text-center"><a href="./Pessoa.php?id=<?php echo $data['ID'] ?>"><?php echo $data['NOME'] ?></a></td>
                        <td class="valor text-center">R$<?php echo $data['TOTAL_VENDA'] ?>,00</td>
                    </tr>
