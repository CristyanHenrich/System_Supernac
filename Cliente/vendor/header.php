    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light"
        ...
        <div class="container-fluid">
            ...
            <section id="PerfilMenuInfo">
                <h6 style="color: #A9A9A9;"><?php if (!isset($_SESSION)) { ?> <a href="../LoginPage.php"
                        style="text-decoration: none; color: #A9A9A9;">Entrar</a>
                    <?php } else { echo $_SESSION['NOME']; } ?></h6>
                <div class="menu-drop">
                    <img id="ImgPerfil"
                        src="<?php if (!isset($_SESSION)) { echo "./img/User.png"; } else { echo "../STORAGE/".$_SESSION['FOTO']; } ?>"
